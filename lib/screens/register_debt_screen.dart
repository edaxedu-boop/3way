...
class RegisterDebtScreenState extends State<RegisterDebtScreen> {
          ...
          data: Theme.of(context).copyWith(
            ...
            textButtonTheme: TextButtonThemeData(
              style: TextButton.styleFrom(
                foregroundColor: Theme.of(context).brightness == Brightness.light ? const Color(0xFF122E2A) : Colors.orange,
              ),
            ),
          ),
          child: child!,
      ...
      try {
        ...
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(content: Text('Deuda registrada con éxito'), backgroundColor: Colors.green),
          );
        ...
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(content: Text('Error al registrar la deuda: ${e.toString()}'), backgroundColor: Colors.red),
          );
        }
      }
    }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('Registrar Nueva Deuda', style: theme.textTheme.titleLarge?.copyWith(color: onBackgroundColor)),
          ...
          child: Column(
            ...
            children: <Widget>[
              TextFormField(
                ...
                decoration: _buildInputDecoration('Descripción de la deuda (Ej: Tarjeta de crédito)', surfaceColor, onBackgroundColor),
                validator: (value) {
              ...
              TextFormField(
                ...
                style: theme.textTheme.bodyMedium?.copyWith(color: onBackgroundColor),
                decoration: _buildInputDecoration('Monto Total de la Deuda', surfaceColor, onBackgroundColor).copyWith(
                  prefixText: 'S/ ',
